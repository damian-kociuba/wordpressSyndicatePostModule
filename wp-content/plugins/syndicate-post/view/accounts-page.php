        ...
        <div class="tab-content" id="tabs-<?php echo $i; ?>">
            <form method="POST">
                ...
                <?php foreach ($fields as $field): ?>
                    ...
                    <input class="long-one-line-text" type="text" name="driver_<?php echo $driver->getName();?>_parameter[<?php echo $field['name']; ?>]" <?php if(isset($driver_parameters[$driver->getName()][$field['name']])):?>value="<?php echo $driver_parameters[$driver->getName()][$field['name']];?>"<?php endif;?>>
                    <br />
                <?php endforeach; ?>
